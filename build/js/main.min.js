...
new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.slider__container', {
  loop: true,
  spaceBetween: 40,
  navigation: {
...
var listItem = document.querySelectorAll('.service__list li');
var delay = 0;
window.addEventListener('load', function () {
  listItem.forEach(function (item) {
    item.style.animationDelay = "".concat(delay += 0.1, "s");
